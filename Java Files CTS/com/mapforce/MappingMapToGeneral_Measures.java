/**
 * MappingMapToGeneral_Measures.java
 *
...
public class MappingMapToGeneral_Measures extends com.altova.TraceProvider 
{
	...
	static class main implements IEnumerable
	{
		...
		public static class Enumerator implements IEnumerator
		{
			...
			private boolean moveNext_7() throws Exception {
				...
				current = com.altova.functions.Core.resultDocument(com.altova.functions.Core.concat("General", com.altova.CoreTypes.integerToString(var7_cast)), "", (new seq9_join(var5_filter, var8_filter, var7_cast)));
				pos++;
				return true;
			}
	...
	static class seq9_join implements IEnumerable
	{
		...
		java.math.BigInteger var3_shared;
	
		public seq9_join(com.altova.mapforce.IEnumerable var1_shared, com.altova.mapforce.IEnumerable var2_shared, java.math.BigInteger var3_shared)
		{
			this.var1_shared = var1_shared;
		...
		public static class Enumerator implements IEnumerator
		{
			...
			private boolean moveNext_6() throws Exception {
				...
				if (!(com.altova.functions.Core.logicalAnd(com.altova.functions.Core.equalOrGreater(var8_cast, new java.math.BigDecimal("19")), com.altova.functions.Core.equalOrLess(var8_cast, new java.math.BigDecimal("38"))))) {state = 6; return false; }
	...
	static class seq11_join implements IEnumerable
	{
		...
		public seq11_join(com.altova.mapforce.IMFNode var1_current, com.altova.mapforce.IEnumerable var2_shared, java.math.BigInteger var3_shared)
		{
		...
		public static class Enumerator implements IEnumerator
		{
			...
			private boolean moveNext_5() throws Exception {
				...
				if (!((Boolean)com.altova.functions.Core.first((new seq2_CoreAny((new seq12_cond_c(((com.altova.mapforce.IMFNode)(var4_shared.current())), var6_c, ((com.altova.mapforce.IMFNode)(var5_filter.current())), closure.var3_shared))))))) {state = 5; return false; }
	...
	static class seq12_cond_c implements IEnumerable
	{
		...
		java.math.BigInteger var4_shared;
	
		public seq12_cond_c(com.altova.mapforce.IMFNode var1_current, com.altova.mapforce.IEnumerable var2_shared, com.altova.mapforce.IMFNode var3_current, java.math.BigInteger var4_shared)
		{
			this.var1_current = var1_current;
			this.var2_shared = var2_shared;
	...
	public void run(com.altova.io.Input CTS_Evaluation_FileSource) throws Exception {
		...
		com.mapforce.Text_file.Text_fileDocument General_MeasuresTargetDoc = new com.mapforce.Text_file.Text_fileDocument(com.mapforce.Text_file.Text_file_TypeInfo.binder.getTypes()[com.mapforce.Text_file.Text_file_TypeInfo._altova_ti_altova_RowsType],0);
		com.altova.text.tablelike.Table General_MeasuresTargetObject = General_MeasuresTargetDoc;
			General_MeasuresTargetDoc.getFormat().setAssumeFirstRowAsHeaders( false );
			General_MeasuresTargetDoc.getFormat().setFieldDelimiter( ',' );
			General_MeasuresTargetDoc.getFormat().setRemoveEmpty( true );
			General_MeasuresTargetDoc.getFormat().setQuoteCharacter( '\"' );
		  com.altova.io.Output General_MeasuresTarget = new com.altova.io.FileOutput(doc.getFilename());
		  com.altova.text.MFTextWriter.write(doc.select(IMFNode.MFQueryKind_All, null), General_MeasuresTargetObject);
		General_MeasuresTargetDoc.setEncoding( "UTF-8", false, false );
		General_MeasuresTargetDoc.save(General_MeasuresTarget);
		  General_MeasuresTarget.close();
		}
