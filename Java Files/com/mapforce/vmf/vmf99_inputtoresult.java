...
public class vmf99_inputtoresult extends com.altova.TraceProvider 
{
	...
	public static IEnumerable create(double var1_input)
	{
		...
		if (o != null)
			...
			return new MFSingletonSequence(com.altova.CoreTypes.box("Gross"));
