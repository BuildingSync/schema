...
public class vmf104_inputtoresult extends com.altova.TraceProvider 
{
	...
	public static IEnumerable create(java.lang.String var1_input)
	{
		...
		if (o != null)
			...
			return new MFSingletonSequence(com.altova.CoreTypes.box("Electricity"));
