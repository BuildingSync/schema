...
- the [BuildingSync schema documentation](https://buildingsync.net/dictionary/2.7.0/)
...
4. Generating a BuildingSync file and verifying it against version 2.7.0 of the BuildingSync schema
