...
- We will be using BuildingSync version 2.7.0. [Documentation](https://buildingsync.net/documentation/2.7.0). [Github release](https://github.com/BuildingSync/schema/releases/tag/v2.7.0).
